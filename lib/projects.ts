...
export const PROJECTS: Project[] = [
  ...
  },
  {
    slug: "augere-global",
    title: "Augere Global",
    type: "Corporate website · Advisory firm",
    url: "https://augereglobal.com",
    accent: "#c8697d",
    outcome: "A Nairobi advisory firm lands on a domain that matches its reach: Africa, Gulf, Asia.",
    description:
      "Corporate website for Augere Global, a capital raising and customer experience advisory firm operating across Africa, the Gulf and Asia. Two services, one standard: helping businesses raise capital and close deals, and helping them deliver better customer experiences.",
    meta: "HTML · CSS · JavaScript · Corporate",
    year: "2026",
    role: "Design and development",
    location: "Nairobi, Kenya",
    palette: [
      { name: "Wine",    hex: "#6b1c2e" },
      { name: "Rose",    hex: "#c8697d" },
      { name: "Cream",   hex: "#f5f0eb" },
      { name: "Onyx",    hex: "#141010" },
    ],
    intro:
    ...
    screens: [
      { src: "/images/augere-global/hero.png",     label: "Hero"         },
      { src: "/images/augere-global/hero-2.png",   label: "Hero"         },
      { src: "/images/augere-global/services.png", label: "Services"     },
      { src: "/images/augere-global/contact.png",  label: "Contact"      },
    ],
  },
  {
    slug: "ticketforge",
